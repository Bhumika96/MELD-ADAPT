...
a=np.loadtxt('dummy.dat')
max_val = 121
params = (a / max_val) * 100
np.save('no_ps_percentage.npy',params)

def make_subplots():
    files_satisfied = [
        '/orange/alberto.perezant/bhumika/PARAMETER_SAMPLING/no_ps/3GB1/analysis/satisfied_peak_hydrophobe.dat',
        '/orange/alberto.perezant/bhumika/PARAMETER_SAMPLING/0.25/3GB1/analysis/satisfied_peak_hydrophobe.dat',
        '/orange/alberto.perezant/bhumika/PARAMETER_SAMPLING/0.5/3GB1/analysis/satisfied_peak_hydrophobe.dat',
        '/orange/alberto.perezant/bhumika/PARAMETER_SAMPLING/1.0/3GB1/analysis/satisfied_peak_hydrophobe.dat',
        '/orange/alberto.perezant/bhumika/PARAMETER_SAMPLING/2.0/3GB1/analysis/satisfied_peak_hydrophobe.dat',
        '/orange/alberto.perezant/bhumika/PARAMETER_SAMPLING/4.0/3GB1/analysis/satisfied_peak_hydrophobe.dat',
        '/orange/alberto.perezant/bhumika/PARAMETER_SAMPLING/8.0/3GB1/analysis/satisfied_peak_hydrophobe.dat'
    ]

    files_enforced = [
        'no_ps_percentage.npy',
        '0.25_params.npy',
        '0.5_params.npy',
        '1.0_params.npy',
        '2.0_params.npy',
    ...
    for i in range(len(files_satisfied)):
        ...
        constant = (15 / max_val) * 100
        ax.vlines(constant, ymin=0, ymax=8000, linestyle='--', color='black', linewidth=5.0)
    ...
    # Save the figure
    plt.savefig('test_subplots.pdf', dpi=320)
    plt.show()
