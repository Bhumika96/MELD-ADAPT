...
def visualize_multiple_parameters(files):
    ...
    for i, file in enumerate(files):
        ...
        for replica_index in range(params_data.shape[1]):  # Iterate over 30 replicas
            ...
            kde = gaussian_kde(params_data[1, replica_index], bw_method='scott')
        ...
        ax.set_yticks(np.arange(0, 0.85, 0.4))
...
#        all_labels.extend(labels)
    ...
    plt.tight_layout()
    plt.savefig('combined_histogram_distributions_p2.png', dpi=320)
    plt.show()
